...
/**
 * <h1>BoardAT</h1> 
 * creates a board for player A
 * @author Nikou Kalabali Student number 001228157
 * @version 1
 */
public class BoardAT {
	/**
	 * 
	 */
	/**
	 * creates a BoardAT with given arguments
	...
	public BoardAT(CoordinateT c, double w, double h) throws OutOfBoundsException {
		width = w;
		height = h;
		lower_left = c;
...
//citation: I have used some of my Assignment 3 code for this assignment 
